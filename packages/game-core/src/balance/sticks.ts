...
export const STICKS: readonly Stick[] = [
  {
    ...
    name: 'Тренировочная',
    rarity: 'common',
    effects: { shotZoneMultiplier: 1.0, rewardMultiplier: 1.0, streakGrowthMultiplier: 1.0 },
  },
  {
    id: 'junior',
    name: 'Юниорская',
    rarity: 'rare',
    effects: { shotZoneMultiplier: 1.1, rewardMultiplier: 1.0, streakGrowthMultiplier: 1.0 },
  },
  {
    id: 'professional',
    name: 'Профессиональная',
    rarity: 'epic',
    effects: { shotZoneMultiplier: 1.2, rewardMultiplier: 1.2, streakGrowthMultiplier: 1.0 },
  },
  {
    id: 'sokol',
    name: 'Легендарная «Сокол»',
    rarity: 'legendary',
    effects: { shotZoneMultiplier: 1.3, rewardMultiplier: 1.5, streakGrowthMultiplier: 1.5 },
  },
];
