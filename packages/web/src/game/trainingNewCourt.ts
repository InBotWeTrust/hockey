...
export const TRAINING_NEW_COURT_GOALIE_VISUAL_Y_OFFSET = PERSPECTIVE_COURT_GOALIE_VISUAL_Y_OFFSET;
export const TRAINING_NEW_COURT_GOAL_VISUAL_OFFSET_X_SCALE =
  PERSPECTIVE_COURT_GOAL_VISUAL_OFFSET_X_SCALE;
export const TRAINING_NEW_COURT_GOALIE_VISUAL_X_SCALE = PERSPECTIVE_COURT_GOALIE_VISUAL_X_SCALE;
...
export const TRAINING_NEW_COURT_PUCK_FLIGHT_VISUAL_Y_OFFSET =
  PERSPECTIVE_COURT_PUCK_FLIGHT_VISUAL_Y_OFFSET;
export const TRAINING_NEW_COURT_HITBOX_GOAL_WIDTH_SCALE = PERSPECTIVE_COURT_HITBOX_GOAL_WIDTH_SCALE;
...
export function distanceToNewTrainingCourtGoalEdge(shooterX: number, goalOffsetX: number): number {
