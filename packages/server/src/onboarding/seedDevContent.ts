...
function beginnerSteps(unlockGoalsRequired: number): SeedStep[] {
  return [
    ...
    },
    {
      ...
      description:
        'На следующий вечер незнакомец уже ждёт тебя у коробки.\n\n— Игра показывает твой результат. Тренировка меняет тебя. Раз в сутки у тебя есть 100 бросков — выбирай скорость любого из трёх периодов и отрабатывай момент.',
