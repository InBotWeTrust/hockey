...
const noInventoryNutritionFields: Array<{
  ...
  {
    field: 'fatigueHeavySlowdownStartMs',
    key: 'fatigue_heavy_slowdown_start_ms',
    label: 'Усталость: тяжёлое замедление',
    description:
  ...
  },
  {
    ...
    description: 'Сколько миллисекунд игрок стоит и не может бросать во время отдыха.',
    min: 0,
    max: 120_000,
  },
  {
  ...
  {
    field: 'fatigueHeavyMultiplier',
    key: 'fatigue_heavy_multiplier',
    label: 'Усталость: тяжёлый множитель',
    description:
