...
update bonus_game as game
   set target_goals = definition.target_points,
       ...
       preview_story = 'Дождитесь момента для гола: чем короче окно для удачного броска, тем больше очков. Борт и положение вратаря могут повысить оценку, но очки за признаки не складываются.',
