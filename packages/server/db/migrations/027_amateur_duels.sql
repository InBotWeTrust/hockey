...
create table amateur_duel_template (
  ...
  ranked_daily_limit int not null default 100 check (ranked_daily_limit >= 0),
  ranked_same_opponent_limit int not null default 100 check (ranked_same_opponent_limit >= 0),
